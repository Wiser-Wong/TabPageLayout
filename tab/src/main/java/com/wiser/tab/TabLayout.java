 ...
 *         tab
 */
public class TabLayout extends FrameLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {

	private TabPageView tabPageView;								// 页 布局
	...
	public TabLayout(@NonNull Context context, @NonNull AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}
	...
	public TabPageView tabPageView() {
		return tabPageView;
	}
	 ...
	 * @param isScroll
	 */
	public TabLayout isPageCanScroll(boolean isScroll) {
	 ...
	 * @param tabIds
	 */
	public TabLayout tabIds(@IdRes int... tabIds) {
		this.tabIds = tabIds;
	 ...
	 * @param fragments
	 */
	public TabLayout setPages(@IdRes int tabPageId, Fragment... fragments) {
	 ...
	 */
	public TabLayout isTabCutPageAnim(boolean isTabCutPageAnim) {
	...
	public TabLayout setOnTabPageChangeListener(OnTabPageChangeListener onTabPageChangeListener) {
		this.onTabPageChangeListener = onTabPageChangeListener;
		return this;
	}

	public TabLayout setOnTabSwitchPageListener(OnTabSwitchPageListener onTabSwitchPageListener) {
